...
<head>
    ...
    <link rel="stylesheet" href="${pathToRoot}dokka-template.css">
    </@template_cmd>
</head>
<body>
<div class="root">
...
<@template_cmd name="pathToRoot">
<script defer src="${pathToRoot}shared.js" type="text/javascript"></script>
<script defer src="${pathToRoot}dokka-template.js" type="text/javascript"></script>
</@template_cmd>
