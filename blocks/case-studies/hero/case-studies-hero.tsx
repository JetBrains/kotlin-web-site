...
export const CaseStudiesHero: React.FC = () => {
    ...
    return (
        <section className="ktl-layout ktl-layout--center" data-testid="case-studies-hero"
            ...
            <div className={styles.content}>
                ...
                <p className={cn(textCn('rs-text-1'), styles.subtitle)} data-testid="case-studies-hero-subtitle">
                    ...
                    building cross-platform applications with shared logic and UI to developing reliable,
                    high-performance backends — explore real-world strategies, integration approaches, and the benefits
