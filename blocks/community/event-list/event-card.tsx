        ...
        <a className={cardClassName} href={event.url} target={'_blank'} rel="noopener noreferrer">
            <div className={styles.header}>
                ...
                <div className={styles.tags}>
                    {event.online && <Tag {...tagStyle} isUppercase className={styles.tag}><span className={styles.dot}>•</span>Online</Tag>}
                    <Tag {...tagStyle} isUppercase className={styles.tag}>{event.lang}</Tag>
                </div>
            </div>
