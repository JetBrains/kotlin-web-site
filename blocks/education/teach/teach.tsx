      ...
      <section className="ktl-layout ktl-layout--center ktl-offset-top-xl">
        ...
        <div className="ktl-offset-top-l">
          <div className={styles.topButtons}>
            ...
            <Button size="l" mode="outline" href="/education/why-teach-kotlin/" className="teach-cta-block-button">
              Why Teach Kotlin&nbsp;→
            </Button>
          </div>
        </div>
            ...
            <li className={styles.firstList}>
              ...
              <ul className="teach-list">
                <li className={styles.listItem}>
                  <Link href="/docs/kotlin-tour-welcome.html" className={textCn('rs-link', {external: true})}>
                    Tour of Kotlin
                  </Link>
                </li>
                <li className={styles.listItem}>
