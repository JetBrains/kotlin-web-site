...
// Note: These components would need to be migrated to the new structure
// For now, we'll import them from their current location
...
export const Teach: FC<TeachProps> = ({ countriesCount, universitiesCount }) => {
    ...
    return (
        <div className={styles.wrapper} data-test="teach-index-page">
                        ...
                        <div className="teach-feature">
                            ...
                            <div className={styles.featureContent}>
                                ...
                                <div className="ktl-text-2">
                                    Over 300 of the world's top universities include Kotlin in various computer science
                                    courses (as of June 2023).
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="ktl-col-12 ktl-col-md-4">
                        <div className="teach-feature">
                            ...
                            <div className={styles.featureContent}>
                                ...
                                <div className="ktl-text-2">
                                    Kotlin is a top choice for teaching Android development. It is also being adopted
                                    for
            ...
            <section
                className="ktl-offset-top-xxl ktl-with-anchor"
                ...
                <div className="ktl-layout ktl-layout--center">
                    ...
                    <div className={`${styles.universitiesLogos} ktl-offset-top-m`}>
                        <div className={styles.logos}>
                            <div className={styles.logosLogo}>
                                <img
                    ...
                    <TeachMap className={styles.mapWrapper} />
            ...
            <section className="ktl-offset-top-xxl ktl-with-anchor" id="start-teaching-kotlin">
                <div className="ktl-layout ktl-layout--center">
                    ...
                    <ul className={styles.links}>
                        <li className={styles.firstList}>
                            ...
                            <ul className="teach-list">
                                <li className={styles.listItem}>
                                    <Link href="/docs/kotlin-tour-welcome.html"
                                          className={textCn('rs-link', { external: true })}>
                                        Tour of Kotlin
                                    </Link>
                                </li>
                                <li className={styles.listItem}>
                                    <a href="https://jb.gg/academy/kotlin-onboarding"
                                       className={textCn('rs-link', { external: true })} target="_blank"
                                       rel="noopener noreferrer">
                                        Kotlin Onboarding: Introduction
                                    </a>
                                </li>
                                <li className={styles.listItem}>
                                    <a href="https://jb.gg/academy/kotlin-oop"
                                       className={textCn('rs-link', { external: true })} target="_blank"
                                       rel="noopener noreferrer">
                                ...
                                <li className={styles.listItem}>
                                    <a href="https://jb.gg/academy/kotlin-collections"
                                       className={textCn('rs-link', { external: true })} target="_blank"
                                       rel="noopener noreferrer">
                                ...
                                <li className={styles.listItem}>
                                    <a href="https://jb.gg/refactoring-kotlin"
                                       className={textCn('rs-link', { external: true })} target="_blank"
                                       rel="noopener noreferrer">
                                ...
                                <li className={styles.listItem}>
                                    <a href="https://jb.gg/academy/kotlin-algorithm"
                                       className={textCn('rs-link', { external: true })} target="_blank"
                                       rel="noopener noreferrer">
                                ...
                                <li className={styles.listItem}>
                                    <div className={`ktl-text-2 ${styles.dimmedText}`}>Atomic Kotlin:</div>
                                    <ul className={`teach-list ${styles.sublist}`}>
                                        <li className={styles.listItem}>
                                            <a
                        ...
                        <li className={styles.fourthList}>
