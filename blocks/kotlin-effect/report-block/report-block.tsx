    ...
    return (
        <div className={styles.reportBlock}>
            ...
            <div className={cn(darkTextCn('rs-text-1', { hardness: 'hard' }), styles.text)}>
                The Kotlin Effect didn’t happen overnight. Over the past 15 years, Kotlin has grown into a language and
                platform trusted by millions of developers worldwide.
            </div>
            <div className={cn(darkTextCn('rs-text-2', { hardness: 'average' }), styles.text)}>
                The State of Kotlin Report brings together data from across the ecosystem to show how Kotlin is evolving
