...
import { SectionHeading } from '@/blocks/state-of-kotlin-2026/shared/section-heading/section-heading';
    ...
    return (
        <section id="ai" className={styles.wrapper} data-testid="sok-ai">
            ...
            <div className={styles.panels}>
                ...
                <div className={styles.panel} data-testid="sok-ai-verified">
                    <div className={styles.verifiedRow}>
                        ...
                        <div className={styles.chartCard} data-testid="sok-ai-validation-chart">
                            ...
                            <p className={cn(styles.chartFootnote, textCn('rs-text-3', { hardness: 'hard' }))}>
                                {VALIDATION_CHART_SOURCE}
                            </p>
                        </div>
                    </div>
                    <div className={styles.quoteGrid}>
                        {VERIFIED_QUOTES.map((quote, index) => (
                            <div className={styles.quoteBox} key={index}>
                                <p className={cn(styles.quoteText, textCn('rs-text-1', { hardness: 'hard' }))}>
                                    ...
                                    <div>
                                        ...
                                        <p
                                            className={cn(
                                                ...
                                                textCn('rs-text-1', { hardness: 'hard' })
                                            )}
                                        >
                ...
                <GoDeeperBanner
                    text="Go deeper: Kotlin&nbsp;+&nbsp;AI"
                    href={REPORT_SECTION_URLS.ai}
                    testId="sok-ai-cta"
                />
            </div>
        </section>
