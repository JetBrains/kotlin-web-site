  ...
  return (
    <div className="teach-wrapper">
      ...
      <div className="ktl-container">
        ...
        <h1 className="ktl-h1 ktl-offset-top-xl ktl-offset-bottom-xl">Why Teach Kotlin</h1>

        <section className="quote-section ktl-offset-bottom-xl">
          ...
          <div className="quote-section__grid">
            <div className="quote-section__content">
              ...
              <p className="ktl-text-1 ktl-offset-bottom-s">
                ...
                Kotlin in their courses. We know of 190 universities that teach Kotlin, which is almost twice as many as
                there were in 2020.
              </p>
              ...
              <p className="ktl-text-1 ktl-offset-bottom-m">
                ...
                software engineering, introductory programming, mobile application development, concurrent programming,
            ...
            <div className="quote-section__info">
              ...
              <p className="ktl-text-2 ktl-offset-bottom-s ktl-dimmed-text">
                of the top 100 universities in the Times Higher Education World University Rankings 2021 include Kotlin
                in
                their courses.
              </p>
            ...
            <div className="quote-section__content">
              ...
              <p className="ktl-text-1 ktl-offset-bottom-m">
                <ul>
                  ...
                  <li className="ktl-offset-bottom-s">
                    — Kotlin is one of the fastest-growing programming languages, ranking fourth in that category in <a
        ...
        <section className="quote-section ktl-offset-bottom-xl">
          ...
          <div className="quote-section__grid">
            ...
            <div className="quote-section__info">
              ...
              <a href="#" className="ktl-text-2 ktl-link">
          ...
          <div className="quote-section__grid">
            <div className="quote-section__content">
              ...
              <p className="ktl-text-1 ktl-offset-bottom-m">
                ...
                converter makes it easy to migrate existing course materials. It also helps students quickly learn the
          ...
          <div className="quote-section__grid">
            <div className="quote-section__content">
              ...
              <p className="ktl-text-1 ktl-offset-bottom-m">
                ...
                functional, imperative, object-oriented, or procedural programming – all within the same language. With
          ...
          <div className="quote-section__grid">
            <div className="quote-section__content">
              ...
              <p className="ktl-text-1 ktl-offset-bottom-s">
                ...
                boilerplate code. Less code written also means less code to test and debug. This language design makes
                Kotlin a highly productive language, and it also simplifies grading homework and understanding the
                students' code. According to an internal Teaching Kotlin survey, Kotlin’s concise and expressive syntax
                is its most beloved feature among educators.
              </p>

              <p className="ktl-text-1 ktl-offset-bottom-m">
                Kotlin promotes writing correct programs with static type checking and automatic memory management. It
                rules out null-pointer dereferences and has no explicit pointers or undetectable uninitialized
                variables. Type safety and null safety are some of the most beloved features among Kotlin instructors,
        ...
        <section className="quote-section ktl-offset-bottom-xl">
          ...
          <div className="quote-section__grid">
            <div className="quote-section__content">
              ...
              <p className="ktl-text-1 ktl-offset-bottom-m">
                Kotlin ranked third among programming languages that developers are planning on learning next, according
                to <a href="https://research.hackerrank.com/developer-skills/2020" target="_blank" className="rs-link">HackerRank’s
            ...
            <div className="quote-section__info">
              ...
              <a href="#" target="_blank" className="ktl-text-2 ktl-link">
        ...
        <section className="quote-section ktl-offset-bottom-xl">
          ...
          <div className="quote-section__grid">
            <div className="quote-section__content">
              ...
              <p className="ktl-text-1 ktl-offset-bottom-s">
                The top tools of the profession are packaged with the language. IntelliJ IDEA Ultimate supports Kotlin
                as a first-class citizen and is free for educators and students. It offers great productivity features,
                such as smart code completion, code inspections, a visual debugger, and more.
              </p>

              <p className="ktl-text-1 ktl-offset-bottom-s">
                The educational EduTools plugin is also available to help learn and teach Kotlin programming. Educators
          ...
          <div className="quote-section__grid">
            <div className="quote-section__content">
              ...
              <p className="ktl-text-1">
                Open source at heart, Kotlin is a free language that runs on all major platforms. Kotlin is supported
                by, and evolves with the help of, its diverse and enthusiastic community, which includes over 200 Kotlin
                User Groups all around the world, an active forum, Slack, Reddit, and Stack Overflow communities, and
