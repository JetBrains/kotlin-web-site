...
<a href="https://cash.app/" target="_blank" rel="noreferrer noopener">Cash App ↗</a> is the easiest way to send money, spend money, save money, and buy cryptocurrency. We believe in providing everyone with access to important financial services so they can fully participate in the economy.
</div>
...
APIs, and the decision was made to also use Kotlin Multiplatform to make those generated APIs
...
Within Cash App the value proposition of using Kotlin Multiplatform was twofold: we could
...
features with parts of their business logic in Kotlin Multiplatform. What has made me most
...
business logic we’ve encouraged Kotlin Multiplatform as a solution for, we’ve had the most
...
in adopting Kotlin Multiplatform.
...
increasingly realizing the potential of Kotlin Multiplatform, giving it a shot, and seeing
how powerful it is.

[Alec Kazakova](https://x.com/strongolopolis), Mobile Developer
