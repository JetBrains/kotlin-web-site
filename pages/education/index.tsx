...
function EducationPage() {
    ...
    return (
        <EducationLayout title="Kotlin for Education" dataTestId="teach-index-page">
            ...
            <section
                className={cn(styles.universities, styles.anchorTarget, 'ktl-offset-top-xxl')}
            ...
            <section className={cn(styles.resources, styles.anchorTarget, 'ktl-offset-top-xxl')} id="start-teaching-kotlin">
                <div className="ktl-layout ktl-layout--center">
