...
***
> *Students’ feedback about learning Kotlin is really, really positive*. – Márton Braun, Budapest University of Technology and Economics
...
> *Kotlin has strong support for object-oriented programming, and also support for functional programming*. – Fernando Magno Quintão Pereira, Federal University of Minas Gerais
...
> *Simple syntax. Less code to get more done. At the same time Kotlin has advanced topics such as coroutines." – Zaid Altahat, Northwestern University, University of Wisconsin–Parkside
