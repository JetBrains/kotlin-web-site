                ...
                <div className={cn(styles.grid, 'ktl-offset-top-xl')}>
                    <div className={styles.gridContent}>
                            ...
                            <div className={styles.quoteSectionGrid}>
                                <div className={styles.quoteSectionContent}>
                                    <p className="ktl-text-1 ktl-offset-bottom-s">
                                        ...
                                        introductory programming, mobile application development, concurrent
                                        programming, scientific programming, and more (Source: internal Teaching
                                        Kotlin Study, June 2023).
                                    </p>
                        ...
                        >
                            ...
                            <div className={styles.quoteSectionGrid}>
                                <div className={styles.quoteSectionContent}>
                                    <div className={cn(textCn('rs-text-1'), 'ktl-offset-bottom-m')}>
                                        <ul className="rs-ul">
                                            <li>
                                                Kotlin is used by top companies such as Google, Amazon, Twitter,
                                                Reddit, Netflix, Uber, Slack, just to name a few.
                                            </li>
                                            <li>
                                                Teaching professional software engineering practices improves
                                                students' employment prospects. And knowing that Kotlin is a
                                                marketable skill, students tend to be more enthusiastic in studying
                                                it.
                                            </li>
                                            <li>
                            ...
                            <div className={styles.quoteSectionGrid}>
                                <div className={styles.quoteSectionContent}>
                                    <p className="ktl-text-1 ktl-offset-bottom-m">
                                        ...
                                        programming, data science, and other computer science topics.
                                    </p>
                            ...
                            <div className={styles.quoteSectionGrid}>
                                <div className={styles.quoteSectionContent}>
                                    <p className="ktl-text-1 ktl-offset-bottom-m">
                                        ...
                                        converter (J2K) that automatically converts Java files to Kotlin.
                                    </p>
                            ...
                            <div className={styles.quoteSectionGrid}>
                                <div className={styles.quoteSectionContent}>
                                    <p className="ktl-text-1 ktl-offset-bottom-m">
                                        ...
                                        procedural programming - all within the same language. With Kotlin's support
                                        for coroutines, the concepts of concurrency and parallelism come naturally.
                                    </p>
                            ...
                            <div className={styles.quoteSectionGrid}>
                                <div className={styles.quoteSectionContent}>
                                    <p className="ktl-text-1 ktl-offset-bottom-s">
                                        ...
                                        code to test and debug. This language design makes Kotlin a highly
                                        productive language, and it also simplifies grading homework and
                                        understanding the students' code.
                                    </p>

                                    <p className="ktl-text-1 ktl-offset-bottom-m">
                                        Kotlin promotes writing correct programs with static type checking and
                                        automatic memory management. It rules out null-pointer dereferences and has
                                        no explicit pointers or undetectable uninitialized variables.
                                    </p>
                            ...
                            <div className={styles.quoteSectionGrid}>
                                <div className={styles.quoteSectionContent}>
                                    <p className="ktl-text-1 ktl-offset-bottom-s">
                                        ...
                                        educators and students. It offers great productivity features, such as smart
                                        code completion, code inspections, a visual debugger, and more.
                                    </p>

                                    <p className="ktl-text-1 ktl-offset-bottom-s">
                                        The educational JetBrains Academy plugin is also available to help learn and
                                        teach Kotlin programming. Educators can use existing interactive courses or
                                        create custom ones, with hands-on assignments and practice coding tasks.
                                        Integrated tests will automatically check the assignments and provide
                                        feedback.
                                    </p>
                    ...
                    <div className={styles.gridNav}>
                        <ul className={cn('ktl-text-2', styles.nav)}>
                            ...
                            <li className={styles.navItem}>
                                <a href="#language-of-the-industry" className={styles.navLink}>
                                    <span className="rs-link">Language of the industry</span>
                                </a>
                            </li>
                            <li className={styles.navItem}>
                                <a href="#multiplatform" className={styles.navLink}>
                                    <span className="rs-link">Multiplatform</span>
                                </a>
                            </li>
                            <li className={styles.navItem}>
                                <a href="#interoperable" className={styles.navLink}>
                                    <span className="rs-link">Interoperable</span>
                                </a>
                            </li>
                            <li className={styles.navItem}>
                                <a href="#supports-multiple-paradigms" className={styles.navLink}>
                                    <span className="rs-link">Supports multiple paradigms</span>
                                </a>
                            </li>
                            <li className={styles.navItem}>
                                <a href="#modern-concise-and-safe" className={styles.navLink}>
                                    <span className="rs-link">Modern, concise, and safe</span>
                                </a>
                            </li>
                            <li className={styles.navItem}>
                                <a href="#tooling" className={styles.navLink}>
...
export default WhyTeachKotlinPage;
