...
> 5. Affected versions, when did the problem appear
...
> Provide information about the changes with regard to the progressive mode
> * Can the proposed changes be implemented immediately in the progressive mode or not, why
```
