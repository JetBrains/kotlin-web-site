...
The Kotlin Foundation does not own any code (or assets other than the trademarks and related items described below). Its main functions are:
...
The code for the project is developed openly on GitHub. The Foundation has no developers on its payroll. Open source contributors hold the copyright for the code they author. The code is distributed under the [Apache License, Version 2.0](https://github.com/JetBrains/kotlin/tree/master/license).

**Trademarks**. The Kotlin trademark and associated marks, logos and domain names belong to the Kotlin Foundation. The Foundation permits the usage of the trademarks according to the Kotlin Brand Usage Guidelines. All usages not permitted automatically, and require explicit written permission from the Foundation.
