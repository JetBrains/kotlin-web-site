...
import { MethodologyHero } from '@/blocks/kotlin-benchmark/methodology/hero';
import { MethodologyContent } from '@/blocks/kotlin-benchmark/methodology/content';
...
export default function KotlinBenchmarkMethodology() {
    return (
        <LandingLayout
            dataTestId={'kotlin-benchmark-methodology'}
