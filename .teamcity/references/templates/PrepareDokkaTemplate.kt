...
fun BuildTypeSettings.configureReferenceTemplate() {
    artifactRules = """dokka-templates/** => dokka-templates""".trimIndent()
    ...
    steps {
        ...
        script {
            ...
            scriptContent = """yarn install --frozen-lockfile""".trimIndent()
            dockerImage = KLANG_NODE_CONTAINER
        }
        script {
            name = "Build Templates"
            scriptContent = """node ./scripts/dokka/generate-templates.js""".trimIndent()
            dockerImage = KLANG_NODE_CONTAINER
        }
    }
}
