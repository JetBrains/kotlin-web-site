...
Please see the section on exceptions in the [Java Interoperability section]({% post_url docs/2013-11-15-java-interop %}) for information about Java interoperability.
