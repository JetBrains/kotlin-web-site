...
* If people really want to hack, there still are ways: you can always write your hack in Java & implement it in Kotlin (*see [Java Interop](java-interop.html)*), and Aspect frameworks always work for these purposes
