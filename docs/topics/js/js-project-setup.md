...
The Kotlin/JS plugin uses webpack %webpackMajorVersion%. You can switch to a webpack version from previous versions of 
the plugin (for example, webpack 4) by adding the following line to the project's `gradle.properties`:
