...
| Name | Property name | Description | Possible values |Default value | Platforms |
|------|---------------|-------------|-----------------|--------------| ---------- |
| `nowarn` | | Generate no warnings | true, false | false | JVM, JS |
| `languageVersion` | kotlin.compiler.languageVersion | Provide source compatibility with the specified version of Kotlin | "1.2" (DEPRECATED), "1.3", "1.4", "1.5" (EXPERIMENTAL) | | JVM, JS |
| `apiVersion` | kotlin.compiler.apiVersion | Allow using declarations only from the specified version of bundled libraries | "1.2" (DEPRECATED), "1.3", "1.4", "1.5" (EXPERIMENTAL) | | JVM, JS |
| `sourceDirs` | | The directories containing the source files to compile | | The project source roots |  JVM, JS |
| `compilerPlugins` | | Enabled compiler plugins  | | [] |  JVM, JS |
| `pluginOptions` | | Options for compiler plugins  | | [] |  JVM, JS |
| `args` | | Additional compiler arguments | | [] |  JVM, JS |
| `jvmTarget` | `kotlin.compiler.jvmTarget` | Target version of the generated JVM bytecode | "1.6", "1.8", "9", "10", "11", "12", "13", "14", "15" | "1.6" | JVM |
| `jdkHome` | `kotlin.compiler.jdkHome` |  	Include a custom JDK from the specified location into the classpath instead of the default JAVA_HOME | | | JVM |
| `outputFile` | | Destination *.js file for the compilation result | | | JS |
| `metaInfo` |  | Generate .meta.js and .kjsm files with metadata. Use to create a library | true, false | true | JS |
| `sourceMap` | | Generate source map | true, false | false | JS |
| `sourceMapEmbedSources` | | Embed source files into source map | "never", "always", "inlining" | "inlining" | JS |
