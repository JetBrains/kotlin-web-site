...
[//]: # (description: Learn how to migrate from Java collections to Kotlin collections. This guide covers such data structures as Kotlin and Java List, ArrayList, Map, Set, and others)
