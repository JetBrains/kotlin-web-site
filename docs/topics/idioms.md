...
Learn the difference between [Java and Kotlin first item getting](java-to-kotlin-collections-guide.md#getting-the-first-and-the-last-items-of-a-possibly-empty-collection).
