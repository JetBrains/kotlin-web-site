...
* Use the [Kotlin/Native Cocoapods plugin](native-cocoapods.md#cocoapods-integration), which allows you to use a multiplatform project with native targets as a CocoaPods dependency in your iOS project.
