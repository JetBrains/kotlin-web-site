...
|-----------------------------------------------------------|------------------------------------|----------------------------------------------------------------|
| [Integers](numbers.md#integer-types)                      | `Byte`, `Short`, `Int`, `Long`     | `val year: Int = 2020`,<br/> `val amount: Long = 100_000_000`  |
| [Unsigned integers](unsigned-integer-types.md)            | `UByte`, `UShort`, `UInt`, `ULong` | `val score: UInt = 100u`                                       |
| [Floating-point numbers](numbers.md#floating-point-types) | `Float`, `Double`                  | `val currentTemp: Float = 24.5f`, `val price: Double = 19.99`  |
