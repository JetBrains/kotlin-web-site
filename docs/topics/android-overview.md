...
* Developing cross-platform mobile applications, see [Create an app with shared logic and native UI](/docs/multiplatform/multiplatform-create-first-app.html).
