...
for working with databases in Kotlin Mobile Multiplatform projects is the
...
In this article, we’ll show how to start using databases in your cross-platform mobile project with SQLDelight:
