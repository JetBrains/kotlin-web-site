...
* [Updated compatibility with Canary Android Studio](https://youtrack.jetbrains.com/issue/KTIJ-22063).
* [Updated minimum Android SDK to 21 for Android application](https://youtrack.jetbrains.com/issue/KTIJ-22505).
* [Fixed a problem with first launch after installation Xcode](https://youtrack.jetbrains.com/issue/KTIJ-22645).
* [Fixed a problem with Apple run configuration on M1 machines](https://youtrack.jetbrains.com/issue/KTIJ-21781).
* [Fixed a problem with local.properties on Windows OS](https://youtrack.jetbrains.com/issue/KTIJ-22037).
* [Fixed a problem with KN debugger on Canary Android Studio](https://youtrack.jetbrains.com/issue/KT-53976).
