...
Now you can add new functionality to your project. These are popular cases you can encounter in real life applications,
like using Objective-C frameworks and libraries in Kotlin code and composing suspending functions.

## Use the code form Swift
