 ...
 * `actual` denotes a platform-specific implementation in [multiplatform projects](/docs/multiplatform/multiplatform-expect-actual.html).
 ...
 * `expect` marks a declaration as [platform-specific](/docs/multiplatform/multiplatform-expect-actual.html), expecting an implementation in platform modules.
