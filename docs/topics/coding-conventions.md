...
1. Go to **Settings(Preferences on Mac) | Editor | Code Style | Kotlin**.
2. Click **Set from...**.
3. Select **Kotlin style guide** .

### Verify that your code follows the style guide

1. Go to **Settings(Preferences on Mac) | Editor | Inspections | Kotlin**.
...
To enable trailing commas in the IntelliJ IDEA formatter, go to **Settings(Preferences on Mac) | Editor | Code Style | Kotlin**, 
