...
[Learn how to add dependencies](/docs/multiplatform/multiplatform-cocoapods-libraries.html).
...
[Kotlin Multiplatform](/docs/multiplatform/get-started.html) reduces time spent writing and maintaining the same code for [different platforms](/docs/multiplatform/multiplatform-dsl-reference.html#targets) 
...
With the new hierarchical project structure support, you can share code among [several platforms](/docs/multiplatform/multiplatform-dsl-reference.html#targets)
 in a [multiplatform project](/docs/multiplatform/multiplatform-discover-project.html).
...
API by using an [`expect` declaration that needs platform-specific `actual` implementations](/docs/multiplatform/multiplatform-expect-actual.html).

This made it easy to [share code on all platforms](/docs/multiplatform/multiplatform-share-on-platforms.html#share-code-on-all-platforms), but it was
not so easy to [share between only some of the targets](/docs/multiplatform/multiplatform-share-on-platforms.html#share-code-on-similar-platforms), 
...
Now you can do this with the [hierarchical project structure support](/docs/multiplatform/multiplatform-share-on-platforms.html#share-code-on-similar-platforms), which infers and adapts the API and language features 
...
For other combinations of targets, [create a hierarchy manually](/docs/multiplatform/multiplatform-hierarchy.html#manual-configuration)
...
about [sharing code in libraries](/docs/multiplatform/multiplatform-share-on-platforms.html#share-code-in-libraries).
...
[Learn more about usage of platform-dependent libraries](/docs/multiplatform/multiplatform-share-on-platforms.html#connect-platform-specific-libraries).
