...
[migration guide](/docs/multiplatform/multiplatform-android-layout.html) to make the necessary changes in your `build.gradle(.kts)` file.
...
> [Kotlin CocoaPods Gradle plugin](/docs/multiplatform/multiplatform-cocoapods-dsl-reference.html). We expect to add this feature in future Kotlin releases.
>
{style="note"}
...
Refer to our [Compatibility guide for Kotlin Multiplatform](/docs/multiplatform/multiplatform-compatibility-guide.html#migration-from-kotlin-js-gradle-plugin-to-kotlin-multiplatform-gradle-plugin) 
...
* [Android source set layout](/docs/multiplatform/multiplatform-android-layout.html) – Learn about the new Android source set layout.
* [Compatibility guide for Kotlin Multiplatform](/docs/multiplatform/multiplatform-compatibility-guide.html) – Learn about the incompatible changes you might encounter while developing projects with Kotlin Multiplatform.
