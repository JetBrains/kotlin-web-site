...
for [Kotlin Multiplatform](/docs/multiplatform/get-started.html).
...
the compiler in the definition file as `compilerOpts`. If you use [CocoaPods integration](/docs/multiplatform/multiplatform-cocoapods-overview.html), specify
...
the [CocoaPods integration](/docs/multiplatform/multiplatform-cocoapods-overview.html) for static libraries.
...
For more information on frameworks and XCFrameworks, see [Build final native binaries](/docs/multiplatform/multiplatform-build-native-binaries.html).
...
You can find the complete scheme for the default target hierarchy in the [documentation](/docs/multiplatform/multiplatform-hierarchy.html#default-hierarchy-template).
...
For more information, see [Hierarchical project structure](/docs/multiplatform/multiplatform-hierarchy.html#default-hierarchy-template).
...
* [Scope functions](scope-functions.md) – learn how to simplify your code with useful scope functions from the standard
  library.
* [CocoaPods integration](/docs/multiplatform/multiplatform-cocoapods-overview.html) – set up an environment to work with CocoaPods.
