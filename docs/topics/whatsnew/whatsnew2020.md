...
Since Kotlin 1.9.20, the [default hierarchy template](/docs/multiplatform/multiplatform-hierarchy.html#default-hierarchy-template)
...
Learn more about the [hierarchical project structure in Kotlin Multiplatform](/docs/multiplatform/multiplatform-hierarchy.html).
...
* Improved [Swift package export setup page](/docs/multiplatform/multiplatform-spm-export.html) - Learn how to set up Kotlin/Native output that can be consumed by a Swift package manager dependency.
