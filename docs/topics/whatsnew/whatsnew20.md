...
strict separation between common and platform source sets. This change is most noticeable when you use [expected and actual functions](/docs/multiplatform/multiplatform-expect-actual.html#expected-and-actual-functions).
...
conflicting behavior between IntelliJ IDEA or Android Studio and the compiler. For instance, when you used [expected and actual classes](/docs/multiplatform/multiplatform-expect-actual.html#expected-and-actual-classes),
...
Before Kotlin 2.0.0, if you used [expected and actual declarations](/docs/multiplatform/multiplatform-expect-actual.html) in your
...
compile-time library path via the `compileDependencyFiles` [compilation parameter](/docs/multiplatform/multiplatform-dsl-reference.html#compilation-parameters).
...
To learn more about this change and see the migration instructions, see the [Compose compiler](/docs/multiplatform/compose-compiler.html) documentation.
