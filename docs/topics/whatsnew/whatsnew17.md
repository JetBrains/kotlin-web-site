...
CocoaPods, for example, to handle [iOS dependencies](/docs/multiplatform/multiplatform-ios-dependencies.html#with-cocoapods) in
...
See how to set up
the [initial CocoaPods integration](/docs/multiplatform/multiplatform-cocoapods-overview.html#set-up-an-environment-to-work-with-cocoapods).
