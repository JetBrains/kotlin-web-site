...
* **New stable features**: [nested type aliases and data-flow-based exhaustiveness checks for `when` expressions](#new-stable-features).
* **New experimental features**: [unused return value checker, explicit backing fields, Swift export improvements, suspend function export in Kotlin/JS, and more](#new-experimental-features).
* **Changes enabled by default**: [`return` in expression bodies, faster Native release builds, Kotlin/Wasm optimizations, Kotlin/JS improvements, and Compose compiler stack traces](#changes-enabled-by-default).
* **Support for new versions**: [Java 25 and Gradle 9.0.0](#support-for-new-versions).

> Use the **Topic** switcher at the top of the page to filter the updates by topic: Language, Gradle, and so on.
> 
{style="note"}
...
## New stable features {switcher-key="Language, All"}
...
## New experimental features {switcher-key="All, Language, Kotlin/Native, Kotlin/JS, Gradle, Standard library"}

Kotlin 2.3.0 introduces several experimental features across different areas of the language and ecosystem:

* **Language**: [unused return value checker](#unused-return-value-checker), [explicit backing fields](#explicit-backing-fields), and [changes to context-sensitive resolution](#changes-to-context-sensitive-resolution). {switcher-key="All, Language"}
* **Kotlin/Native**: [improved interop through Swift export](#improved-interop-through-swift-export) and [C and Objective-C library import in Beta](#c-and-objective-c-library-import-is-in-beta). {switcher-key="All, Kotlin/Native"}
* **Kotlin/JS**: [new export of suspend function with `JsExport`](#new-export-of-suspend-function-with-jsexport) and [`BigInt64Array` representation for `LongArray`](#usage-of-the-bigint64array-type-to-represent-kotlin-s-longarray-type). {switcher-key="All, Kotlin/JS"}
* **Gradle**: [new API for registering generated sources](#new-api-for-registering-generated-sources-in-gradle-projects). {switcher-key="All, Gradle"}
* **Standard library**: [improved UUID generation and parsing](#improved-uuid-generation-and-parsing). {switcher-key="All, Standard library"}

### Unused return value checker {switcher-key="Language, All"}
...
### Explicit backing fields {switcher-key="Language, All"}
...
### Changes to context-sensitive resolution {switcher-key="Language, All"}
<primary-label ref="experimental-general"/>
<secondary-label ref="language"/>
...
### Improved interop through Swift export {switcher-key="Kotlin/Native, All"}
<primary-label ref="experimental-general"/>
...
### C and Objective-C library import is in Beta {switcher-key="Kotlin/Native, All"}
...
### New export of suspend function with `JsExport` {switcher-key="Kotlin/JS, All"}
<primary-label ref="experimental-opt-in"/>
...
### Usage of the `BigInt64Array` type to represent Kotlin's `LongArray` type {switcher-key="Kotlin/JS, All"}
<primary-label ref="experimental-opt-in"/>
<secondary-label ref="js"/>
...
### New API for registering generated sources in Gradle projects {switcher-key="Gradle, All"}
<primary-label ref="experimental-general"/>
...
### Improved UUID generation and parsing {switcher-key="Standard library, All"}
<primary-label ref="experimental-opt-in"/>
...
## Changes enabled by default {switcher-key="All, Language, Kotlin/Native, Kotlin/Wasm, Kotlin/JS, Compose compiler"}

Several features and optimizations are now enabled by default in Kotlin 2.3.0:

* **Language**: [support for `return` statements in expression bodies](#support-for-return-statements-in-expression-bodies). {switcher-key="All, Language"}
* **Kotlin/Native**: [explicit names in block types for Objective-C headers](#default-explicit-names-in-block-types-for-objective-c-headers) and [performance improvements for release builds](#faster-build-time-for-release-tasks). {switcher-key="All, Kotlin/Native"}
* **Kotlin/Wasm**: [fully qualified names](#fully-qualified-names-enabled-by-default), [compact storage for Latin-1 characters](#compact-storage-for-latin-1-characters), and [new exception handling for `wasmWasi`](#new-exception-handling-proposal-enabled-by-default-for-wasmwasi). {switcher-key="All, Kotlin/Wasm"}
* **Kotlin/JS**: [unified companion object access](#unified-companion-object-access-across-js-module-systems), [`@JsStatic` in interfaces with companion objects](#support-for-jsstatic-annotations-in-interfaces-with-companion-objects), [`@JsQualifier` for individual functions and classes](#jsqualifier-annotation-allowed-in-individual-functions-and-classes), and [JavaScript default exports](#support-for-javascript-default-exports). {switcher-key="All, Kotlin/JS"}
* **Compose compiler**: [stack traces for minified Android applications](#compose-compiler-stack-traces-for-minified-android-applications). {switcher-key="All, Compose compiler"}

### Support for `return` statements in expression bodies {switcher-key="Language, All"}
<secondary-label ref="language"/>
...
### Default explicit names in block types for Objective-C headers {switcher-key="Kotlin/Native, All"}
<secondary-label ref="native"/>
...
### Faster build time for release tasks {switcher-key="Kotlin/Native, All"}
<secondary-label ref="native"/>
...
### Fully qualified names enabled by default {switcher-key="Kotlin/Wasm, All"}
...
### Compact storage for Latin-1 characters {switcher-key="Kotlin/Wasm, All"}
<secondary-label ref="wasm"/>
...
### New exception handling proposal enabled by default for `wasmWasi` {switcher-key="Kotlin/Wasm, All"}
<secondary-label ref="wasm"/>
...
### Unified companion object access across JS module systems {switcher-key="Kotlin/JS, All"}
<secondary-label ref="js"/>
...
### Support for `@JsStatic` annotations in interfaces with companion objects {switcher-key="Kotlin/JS, All"}
<secondary-label ref="js"/>
...
### `@JsQualifier` annotation allowed in individual functions and classes {switcher-key="Kotlin/JS,All"}
<secondary-label ref="js"/>
...
### Support for JavaScript default exports {switcher-key="Kotlin/JS, All"}
<secondary-label ref="js"/>
...
### Compose compiler: Stack traces for minified Android applications {switcher-key="Compose compiler, All"}
...
## Support for new versions {switcher-key="All, Kotlin/JVM, Gradle"}

Kotlin 2.3.0 adds support for the latest versions of Java and Gradle:

* **Kotlin/JVM**: [support for Java 25 bytecode generation](#support-for-java-25). {switcher-key="All, Kotlin/JVM"}
* **Gradle**: [full compatibility with Gradle versions up to 9.0.0](#support-for-gradle-9-0-0). {switcher-key="All, Gradle"}

### Support for Java 25 {switcher-key="Kotlin/JVM, All"}
<secondary-label ref="jvm"/>

Starting with Kotlin 2.3.0, the compiler can generate classes containing Java 25 bytecode.

### Support for Gradle 9.0.0 {switcher-key="Gradle, All"}
<secondary-label ref="gradle"/>
...
### Changes to Apple target support {switcher-key="Kotlin/Native, All"}
<secondary-label ref="native"/>
