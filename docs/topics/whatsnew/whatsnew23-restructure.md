...
* **Kotlin/JVM**: [support for Java 25](#kotlin-jvm).
...
* **Compose compiler**: [stack traces for minified Android applications](#stack-traces-for-minified-android-applications).
...
### Support for nested type aliases {id=support-for-nested-type-aliases}
...
### Data-flow-based exhaustiveness checks for `when` expressions {id=data-flow-based-exhaustiveness-checks-for-when-expressions}
<secondary-label ref="language"/>
...
### Support for JavaScript default exports {id=support-for-javascript-default-exports}
...
### C and Objective-C library import is in Beta {id=c-and-objective-c-library-import-is-in-beta}
...
### Unused return value checker {id=unused-return-value-checker}
...
### Explicit backing fields {id=explicit-backing-fields}
<primary-label ref="experimental-opt-in"/>
<secondary-label ref="language"/>
...
### Changes to context-sensitive resolution {id=changes-to-context-sensitive-resolution}
...
### Improved interop through Swift export {id=improved-interop-through-swift-export}
<primary-label ref="experimental-general"/>
<secondary-label ref="native"/>
...
### New export of suspend function with `JsExport` {id=new-export-of-suspend-function-with-jsexport}
<primary-label ref="experimental-opt-in"/>
<secondary-label ref="js"/>
...
### Usage of the `BigInt64Array` type to represent Kotlin's `LongArray` type {id=usage-of-the-bigint64array-type}
<primary-label ref="experimental-opt-in"/>
<secondary-label ref="js"/>
...
### New API for registering generated sources in Gradle projects {id=new-api-for-registering-generated-sources-in-gradle-projects}
<primary-label ref="experimental-general"/>
...
### Improved UUID generation and parsing {id=improved-uuid-generation-and-parsing}
<primary-label ref="experimental-opt-in"/>
...
<include from="whatsnew23-restructure.md" element-id="support-for-nested-type-aliases"/>

<include from="whatsnew23-restructure.md" element-id="data-flow-based-exhaustiveness-checks-for-when-expressions"/>

<include from="whatsnew23-restructure.md" element-id="unused-return-value-checker"/>

<include from="whatsnew23-restructure.md" element-id="explicit-backing-fields"/>

<include from="whatsnew23-restructure.md" element-id="changes-to-context-sensitive-resolution"/>
...
<include from="whatsnew23-restructure.md" element-id="c-and-objective-c-library-import-is-in-beta"/>

<include from="whatsnew23-restructure.md" element-id="improved-interop-through-swift-export"/>
...
<include from="whatsnew23-restructure.md" element-id="support-for-javascript-default-exports"/>
...
<include from="whatsnew23-restructure.md" element-id="new-export-of-suspend-function-with-jsexport"/>

<include from="whatsnew23-restructure.md" element-id="usage-of-the-bigint64array-type"/>
...
<include from="whatsnew23-restructure.md" element-id="new-api-for-registering-generated-sources-in-gradle-projects"/>
...
<include from="whatsnew23-restructure.md" element-id="improved-uuid-generation-and-parsing"/>
