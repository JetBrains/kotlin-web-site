...
The feature is currently [Experimental](components-stability.md#stability-levels-explained) and works only in projects that use [direct integration](/docs/multiplatform/multiplatform-direct-integration.html)
...
when you use the [default hierarchy template](/docs/multiplatform/multiplatform-hierarchy.html#default-hierarchy-template).
...
To try this feature, use the [default hierarchy template](/docs/multiplatform/multiplatform-hierarchy.html#default-hierarchy-template) in the `kotlin {}` block of your `build.gradle(.kts)` file:
...
* You have the [CocoaPods integration](/docs/multiplatform/multiplatform-cocoapods-overview.html) set up in your project.
