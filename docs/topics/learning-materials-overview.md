...
* [Advent of Code puzzles](advent-of-code.md) – learn idiomatic Kotlin and practice your language skills by completing short fun tasks from the [Advent of Code](https://adventofcode.com/).
