...
## Operators and Nullable Values

In Kotlin, you can override operators like addition and subtraction for your classes and supply your own logic. But what if you want to allow null values, both on their left and right sides? Sebastian has the answer.

<video width="560" height="315" href="x2bZJv8i0vw" title="Kotlin Tips: Operators and Nullable Values"/>
