...
<tr>
        <td><strong>1.4.30-RC</strong>
            <p> Released: <strong>January 18, 2020</strong></p>
            <p><a href="https://github.com/JetBrains/kotlin/releases/tag/v1.4.30-RC">Release on GitHub</a></p>
        </td>
        <td>
            <ul>
                <li>JVM IR backend reaches Beta</li>
                <li>Inline classes improvements</li>
                <li>JVM records preview (with <code>-language-version 1.5</code> and <code>-Xjvm-enable-preview</code>)</li>
                <li>Sealed interfaces preview (with <code>-language-version 1.5</code>)</li>
            </ul>
            <p>For more details, please refer to the <a href="https://github.com/JetBrains/kotlin/releases/tag/v1.4.30-RC">changelog</a>.</p>
         </td>
        <td>
            <ul>
