...
| `compileDependencyFiles` | Compile-time dependency files (classpath) of the compilation. For all Native compilations, this automatically includes stdlib and platform dependencies. |
