...
You can print statistics on the annotation processors execution using the `-Kapt-show-processor-timings` plugin option. 
An example output:
...
### Measuring number of generated files for each processor
