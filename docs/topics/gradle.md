...
|----------------|--------------------------------------------|-------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Daemon         | Inside its own daemon process              | Yes                     | *The default strategy*. Can be shared between different Gradle daemons and multiple parallel compilations.                                                                                                                                                                                                                                                                                                                                                                                                    |
| In process     | Inside the Gradle daemon process           | No                      | May share the heap with the Gradle daemon. Note that the "In process" execution strategy is *slower* than the "Daemon" execution strategy. Using the "In process" strategy, the Kotlin Gradle plugin is running on the [Worker API](https://docs.gradle.org/current/userguide/worker_api.html) in the [`noIsolation()` mode](https://docs.gradle.org/current/userguide/worker_api.html#changing_the_isolation_mode). In this case, each worker creates a separate classloader to execute the Kotlin compiler. |
| Out of process | In a separate process for each compilation | No                      | The slowest execution strategy. Similar to the "In process", but additionally creates a separate Java process within a Gradle worker to execute a Kotlin compiler.                                                                                                                                                                                                                                                                                                                                            |
