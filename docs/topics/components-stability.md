...
| Kotlin Multiplatform plugin for Android Studio | Beta       | 0.8.0                    | [Versioned separately from the language](/docs/multiplatform/multiplatform-plugin-releases.html) |
