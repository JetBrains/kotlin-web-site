...
* **Stability** status. This shows how quickly each project is evolving and how much risk the users are taking when adopting it.
  The stability status completely coincides with the [stability level of the Kotlin language features and its components](#stability-levels-explained):
    * ![Experimental stability level](project-experimental-kotlin.svg){type="joined"} **/** ![Experimental stability level](project-experimental-kotlin-rounded.svg){type="joined"} stands for **Experimental**
    * ![Alpha stability level](project-alpha-kotlin.svg){type="joined"} **/** ![Alpha stability level](project-alpha-kotlin-rounded.svg){type="joined"} stands for **Alpha**
    * ![Beta stability level](project-beta-kotlin.svg){type="joined"} **/** ![Beta stability level](project-beta-kotlin-rounded.svg){type="joined"} stands for **Beta**
    * ![Stable stability level](project-stable-kotlin.svg){type="joined"} **/** ![Stable stability level](project-stable-kotlin-rounded.svg){type="joined"} stands for **Stable**
