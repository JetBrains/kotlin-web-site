...
Automatically sets [`-jvm-target version`](#jvm-target-version). Works only for [OpenJDK distributions](https://openjdk.java.net/projects/jdk/17/).
Possible values are `1.8`, `9`, `10`, `11`, `12`, `13`, `14`, `15`, `16`, and `17`. The default value is `%defaultJvmTargetVersion%`.
