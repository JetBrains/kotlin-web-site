...
| `languageVersion` | `kotlin.compiler.languageVersion` | Control which Kotlin language features and syntax are available during compilation. For more information, see [`-language-version`](compiler-reference.md#language-version-version).                                                                                                                                            | "2.0", "2.1", "2.2", "2.3", "2.4", "2.5" (EXPERIMENTAL) |                             |
| `apiVersion`      | `kotlin.compiler.apiVersion`      | Control which Kotlin APIs your code can use. For more information, see [`-api-version`](compiler-reference.md#api-version-version).                                                                                                                               | "2.0", "2.1", "2.2", "2.3", "2.4", "2.5" (EXPERIMENTAL) |                             |
