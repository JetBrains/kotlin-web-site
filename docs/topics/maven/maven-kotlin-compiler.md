...
| `jvmTarget`       | `kotlin.compiler.jvmTarget`       | Target version of the generated JVM bytecode.</br>If you use the [`<extensions>` option](maven-configure-project.md#automatic-configuration), the plugin automatically aligns the JVM target version with the Java compiler version. | "1.8", "9", "10", ..., "26"                             | "%defaultJvmTargetVersion%" |
