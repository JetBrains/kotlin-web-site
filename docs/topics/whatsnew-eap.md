...
regular expression match. However there was no common function. It wasn’t possible to have a common function prior to 
Kotlin 1.8.0, because the standard library still supported JVM targets 1.6 and 1.7.

As of Kotlin 1.8.0, the standard library is compiled with JVM target 1.8. So in 1.9.0-RC, there is now a **common** 
