...
configuration of compiler options. It is available for [Kotlin Multiplatform](/docs/multiplatform/multiplatform-dsl-reference.html#compiler-options) and [JVM/Android](#target-the-jvm) projects.
...
specific target. For example, `jvm { compilerOptions {}}`. For more information, see [Multiplatform Gradle DSL reference](/docs/multiplatform/multiplatform-dsl-reference.html).
...
If you want to configure a plugin of a target different from JVM/Android and [Kotlin Multiplatform](/docs/multiplatform/multiplatform-dsl-reference.html),
...
Learn more about:
* [Kotlin Multiplatform DSL reference](/docs/multiplatform/multiplatform-dsl-reference.html). 
