...
| `extraWarnings`   | Enables additional declaration, expression, and type [compiler checks](whatsnew-eap.md#extra-compiler-checks) that emit warnings if true | `true`, `false`           | `false`       |
