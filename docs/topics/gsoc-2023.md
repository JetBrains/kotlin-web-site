...
The Kotlin debugger has the [**Coroutines Panel**](debug-coroutines-with-idea.md#debug-coroutines){origin="coroutines"} that allows a user to view all of the coroutines and their states,
