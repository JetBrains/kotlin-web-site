...
For instance: encoding (base64), compression, crypto.
...
Design and deliver at least one Kotlin Multiplatform library with a greater priority on JVM/Android & Kotlin/Native (iOS)
...
* Improved parameter/argument completion suggestions in IntelliJ IDEA.
...
Currently, coroutines debugging support is very limited in Intellij IDEA.
