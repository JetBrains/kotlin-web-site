[//]: # (title: Google Summer of Code with Kotlin project ideas)

This article has the list of project ideas for Google Summer of Code with Kotlin.

> Link to the source code location: [https://github.com/jetbrains/kotlin](https://github.com/jetbrains/kotlin)  
> Contact: [gsoc@kotlinfoundation.org](mailto:gsoc@kotlinfoundation.org)  
> Join [Kotlin Slack](https://surveys.jetbrains.com/s3/kotlin-slack-sign-up) and  
> read the [#gsoc](https://slack-chats.kotlinlang.org/c/gsoc) Slack channel
> 
{type="note"}
