...
* [Configure compilation for native libraries](/docs/multiplatform/multiplatform-configure-compilations.html#configure-interop-with-native-languages)
...
* See [Build final native binaries](/docs/multiplatform/multiplatform-build-native-binaries.html#declare-binaries) to see how to declare binaries.
