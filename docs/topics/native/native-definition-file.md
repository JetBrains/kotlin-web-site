...
[CocoaPods integration](/docs/multiplatform/multiplatform-cocoapods-overview.html). If dependent libraries aren't installed locally on the machine or configured
