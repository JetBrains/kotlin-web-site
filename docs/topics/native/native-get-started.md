...
For more information about these settings, see the [Multiplatform Gradle DSL reference](/docs/multiplatform/multiplatform-dsl-reference.html).
...
* Learn how to [write Gradle build scripts for real-life Kotlin/Native projects](/docs/multiplatform/multiplatform-dsl-reference.html).
